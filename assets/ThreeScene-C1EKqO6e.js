...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:oi,depthTest:!1,depthWrite:!1})}function Wu(){return new Kn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Qo(),fragmentShader:`
		...
		`,blending:oi,depthTest:!1,depthWrite:!1})}function Xu(){return new Kn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Qo(),fragmentShader:`
		...
		`,blending:oi,depthTest:!1,depthWrite:!1})}function Qo(){return`
...
`].filter(br).join(`
`)),a=Fo(a),a=nl(a,t),a=il(a,t),o=Fo(o),o=nl(o,t),o=il(o,t),a=rl(a),o=rl(o),t.isRawShaderMaterial!==!0&&(S=`#version 300 es
...
}`,zg=`// We use the standard xyz coordinate system here, not the GLSL coordinate system.\r
